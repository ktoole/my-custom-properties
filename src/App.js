...
function App() {
  ...
  function handleOfSizeChange(event) {
    console.log(event.currentTarget.value);
    document.documentElement.style.setProperty('--logo-size', `${event.currentTarget.value}vmin`);
  }

  function onSVGClick() {
    const timing = getComputedStyle(document.documentElement).getPropertyValue('--logo-spinSpeed').replace('s', '');
    ...
    document.documentElement.style.setProperty('--logo-spinSpeed', `${newTiming}s`)
  }
  ...
  return (
    <div className="App">
      <header className="App-header">
        ...
        <p>
          <input name="size" min="0" max="100" type="range" defaultValue="40" onChange={handleOfSizeChange} />
        </p>
